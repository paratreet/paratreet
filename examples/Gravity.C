...
extern bool periodic;
  ...
  void Main_::preTraversalFn(ProxyPack<CentroidData>& proxy_pack) {
  ...
  void Main_::traversalFn(BoundingBox& universe, ProxyPack<CentroidData>& proxy_pack, int iter) {
  ...
  void Main_::postIterationFn(BoundingBox& universe, ProxyPack<CentroidData>& proxy_pack, int iter) {
    if (iter == 0 && verify) {
  ...
  Real Main_::getTimestep(BoundingBox& universe, Real max_velocity) {
  ...
  void Main_::perLeafFn(int indicator, SpatialNode<CentroidData>& leaf, Partition<CentroidData>* partition) {}
