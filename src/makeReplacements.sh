...
replace "void recursive_pup_impl<GroupMeshStreamer<int" "$DECL_H" "<Data>" "<CentroidData>"
replace "void recursive_pup_impl<GroupMeshStreamer<int" "$DEF_H" "<Data>" "<CentroidData>"
replace "obj->GroupMeshStreamer<int" "$DEF_H" "<Data>" "<CentroidData>"
replace "test_marshall.*TramAggregator->insertData" "$DEF_H" "<false>" " "
